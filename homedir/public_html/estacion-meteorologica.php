                        ...
                        <div style="padding:10px 40px 5px; text-align: justify; line-height: 25px;">
                         ...
                         <div class="row notitex">
                            <div class="combo-clima">
                                ...
                                <div>
                                    ...
                                    <select name="mes" id="mes" class="form-control" style="">
                                        <?php $mes = date('m', strtotime('-1 month')); //mes 1 al 12 con 0,  '-1' PARA ELEGIR AL MES ANTERIOR ?>
                                        
                                            <option value="01"<?php if ($mes == "01") {$TextNom = "ENE"; echo " selected";} ?>>ENERO</option>
                                            <option value="02"<?php if ($mes == '02') {$TextNom = "FEB"; echo " selected";} ?>>FEBRERO</option>
                                            <option value="03"<?php if ($mes == '03') {$TextNom = "MAR"; echo " selected";} ?>>MARZO</option>
                                            <option value="04"<?php if ($mes == '04') {$TextNom = "ABR"; echo " selected";} ?>>ABRIL</option>
                                            <option value="05"<?php if ($mes == '05') {$TextNom = "MAY"; echo " selected";} ?>>MAYO</option>
                                            <option value="06"<?php if ($mes == '06') {$TextNom = "JUN"; echo " selected";} ?>>JUNIO</option>
                                            <option value="07"<?php if ($mes == '07') {$TextNom = "JUL"; echo " selected";} ?>>JULIO</option>
                                            <option value="08"<?php if ($mes == '08') {$TextNom = "AGO"; echo " selected";} ?>>AGOSTO</option>
                                            <option value="09"<?php if ($mes == '09') {$TextNom = "SET"; echo " selected";} ?>>SETIEMBRE</option>
                                            <option value="10"<?php if ($mes == '10') {$TextNom = "OCT"; echo " selected";} ?>>OCTUBRE</option>
                                            <option value="11"<?php if ($mes == '11') {$TextNom = "NOV"; echo " selected";} ?>>NOVIEMBRE</option>
                                            <option value="12"<?php if ($mes == '12') {$TextNom = "DIC"; echo " selected";} ?>>DICIEMBRE</option>
                            ...
                            <section class="checkbox-clima" style="margin: 15px 0">
                                ...
                                <div class="checkbox-item">
                                    <input style="width:20px;transform:scale(1.28);" id="SensacionTermica" name="SensacionTermica" type="checkbox" value="SensacionTermica">
                                    <label for="SensacionTermica" >Sensación Térmica</label>
                                </div>   
        ...
        <div class="row" id="conte-clima">
            ...
            <section class="col col-12" style="width: 100%;" id="divlistadoresultado">
                <div class="table-responsive">
                 <!-- ************ITERACION*WHILE**********************************************-->      
                    <?php
                        $nombre_fichero = "https://www.sedir.org.pe/imgs/EstacionMeteorologica/Temperatura-1-".$TextNom.date('Y').".jpg";
                    ...
                    ?>                   
                    <div><img style="width: 100%;padding-bottom: 25px;" src="https://sedir.org.pe/imgs/EstacionMeteorologica/Temperatura-1-<?php echo $TextNom. date("Y"); ?>.jpg" alt="Temperatura (°C)"></div>
                    <div><img style="width: 100%;padding-bottom: 25px;" src="https://sedir.org.pe/imgs/EstacionMeteorologica/Humedad-1-<?php echo $TextNom. date("Y")?>.jpg" alt="Humedad Relativa (%)"></div>
                    <div><img style="width: 100%;padding-bottom: 25px;" src="https://sedir.org.pe/imgs/EstacionMeteorologica/Precipitaciones-1-<?php echo $TextNom. date("Y")?>.jpg" alt="Precipitaciones (mm)"></div>
                    <div><img style="width: 100%;padding-bottom: 25px;" src="https://sedir.org.pe/imgs/EstacionMeteorologica/RadiacionUV-1-<?php echo $TextNom. date("Y")?>.jpg" alt="Índice UV"></div>    
                 <!-- *************************************************************************--> 
                </div>                            
            </section>

            <!--FIN resultado por Ajax  -->

        </div> <!-- FIN RESULTADO DE LA TABLA --> 
