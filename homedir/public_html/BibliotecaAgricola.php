            ...
            <div class="noti-detallee" >
                ...
                <div style="width:100%; padding:8px; ">
                        <div style="display:flex; justify-content:space-between;">
                            <div> 
                            <a href="webinar.php">
                                <div class="notitit" style="padding:15px 0 15px; "><img src="imgs/T-BibliotecaAgricola.jpg" alt=""></div>
                            </a></div> 
                            <div> 
                        ...
                        <div class="notitex">
                            <div style="padding:10px 40px 5px">
                             Te compartimos nuestra <strong>Biblioltec@ Agrícola Digital</strong> donde podrás encontrar material didáctico sobre temas agrícolas, consejos, manuales, recomendaciones y tutoriales para un correcto control agrícola, dirigido a estudiantes, agricultores, técnicos y al empresariado <strong>Agropecuario</strong>.
                            </div>
                        ...
                        <div id="WebinarOficial">
                              ...
                              <!-- *****************************************************************************-->                             
                                          <article class="webinar">
                                                <figure>
                                                    <a href="https://sedir.org.pe/BibliotecaAgricola01.php">
                                                        <!-- **********INSTALACIÓN DE PLANTAS FRUTÍCOLAS **************-->  
                                                        <img src="imgs/Bibliotecavirtual001.jpg" width="140px" alt="Biblioteca Agrícola Digital">
                                                    </a>
                                                </figure>
                                                <p>Instalación de Plantas Frutícolas</p>
                                                <div class="webinar_botones">
                                                    <p><a href="https://sedir.org.pe/BibliotecaAgricola01.php">Ver Detalle</a></p>
                                                </div>
                                           </article>
                              <!-- *****************************************************************************--> 
                                          <article class="webinar">
                                                <figure>
                                                    <a href="https://sedir.org.pe/BibliotecaAgricola02.php">
                                                        <!-- **********ENMIENDAS ORGÁNICAS Y FERTILIZANTES **************-->  
                                                        <img src="imgs/BibliotecaAgricola/Bibliotecavirtual002.jpg" width="140px" alt="Biblioteca Agrícola Digital">
                                                    </a>
                                                </figure>
                                                <p>Enmiendas orgánicas y fertilizantes</p>
                                                <div class="webinar_botones">
                                                    <p><a href="https://sedir.org.pe/BibliotecaAgricola02.php">Ver Detalle</a></p>
                                                </div>
                                           </article>
                              <!-- *****************************************************************************                             
                                          ...
                                          <article class="webinar">
                                                <figure>
                                                    <a href="https://sedir.org.pe/BibliotecaAgricola03.php">-->  
                                                        <!-- **********PRINCIPALES PLAGAS DE PALTO **************-->  
                                                     <!--    <img src="imgs/BibliotecaAgricola/Bibliotecavirtual003.jpg" width="140px" alt="Biblioteca Agrícola Digital">
                                                    </a>
                                                </figure>
                                                <p>Principales plagas de Palto</p>
                                                <div class="webinar_botones">
                                                    <p><a href="https://sedir.org.pe/BibliotecaAgricola03.php">Ver Detalle</a></p>
                                                </div>
                                           </article>
                              *****************************************************************************-->                        
