...
if(isset($_FILES['image']))
{
	...
	{					
		...
		{
			echo "<img src='http://sedir.org.pe/cpanel/summernote/$path' style= 'max-width: 100px';/>";
		}
	} 
	else 
	{
...
$ruta_img = 'http://sedir.org.pe/cpanel/summernote/';
...
if($rs == false) {
    ...
    echo '<p> <a href="http://www.sedir.org.pe/cpanel/summernote/ingreso.php">INGRESAR OTRA NOTICIA</a></p>';
