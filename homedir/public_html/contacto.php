            ...
            <div class="noti-detallee" >
                ...
                <div style="width:60%; padding:8px; ">
                        <div style="display:flex; justify-content:space-between;">
                            <div> 
                                <div class="notitit" style="padding:15px; "><img src="imgs/T-contactos.jpg" alt=""></div>
                            </div> 
                            <div> 
                        ...
                        <div class="notitex">
                            <!-- FORMULARIO-->  
                                ...
                                <div>
                                     <?php include($_SERVER['DOCUMENT_ROOT'].'/form/index.html'); ?>
                                </div>                  
                                <p></p>
                                <p style="padding-left:22px;" class="notitex">Sede Central: Fundo Bellavista Parcela 291 – Moro</p>
                                <p style="padding-left:22px;" class="notitex">Cel.: 962118628 ​ </p>
                                <p style="padding-left:22px;" class="notitex">e-mail: secretaria@sedir.org.pe </p>
