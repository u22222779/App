    ...
    <!--FONDO DE INTERCAMBIO REVISTA Y RADIO -->
        ...
        <!--fondo REVISTA -->
            <div id="hidden" style="display:none;">
                            <div id="tomorrow">
                            <div class="" style="padding: 0; width:312px; height:290px;">
                                <a href="https://www.sedir.org.pe/revista-detalle.php" target="_blank">
                                            <img src="https://sedir.org.pe/revista/img/REVISTA_FLYER_edVI.jpg" style="/* width:90%; */overflow:hidden;border: 1px solid #A9A8A8;padding: 0;width: 312px;height: 290px;">        
                                        </a>
                            </div>
                            </div>
            </div>
        <!--FINfondo REVISTA -->   
                ...
                <!--Fin FONDO DE INTERCAMBIO REVISTA Y RADIO -->
