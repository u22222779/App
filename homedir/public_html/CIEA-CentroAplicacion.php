                ...
                <div style="width:60%; padding:8px; ">
                    <article>
                            ...
                            <div style="display:flex; justify-content:space-between;">
                                <div class="notitit" style="padding:15px; margin-left: -35px;"><img src="imgs/Button-CIEA-centroAplicacion.jpg" alt=""></div>
                                <div> 
                            ...
                            <strong class="notitit" style="padding-left:30px;">Centro de aplicación y prácticas</strong>
                            <p style="padding-left:30px;" class="notitex">
                                Las prácticas de campo que se realiza en el programa de desarrollo de capacidades en el rubro de la fruticultura exige el espacio adecuado para su aplicación. Por ello SEDIR cuenta con un área debidamente implementada para las acciones respectivas. 
