...
<div id="boxed_layout">
	<div id="top_bg">
		...
		<section style="width:1080px; background-color: #FFF;padding-bottom: 25px;margin: auto; background-color: #dbdbdb;">
            <div class="vc_row">
                <div class="vc_row" style="width: 66%; padding: 0;">
                       
                            <a href="https://www.sedir.org.pe/unidades-productivas2025.php" style="text-align: center;">
                                <div class="vc_row_img1"></div>
                            </a>
                        
                            <a href="publicaciones.php" target="_blank" style="text-align: center;">
                                <div class="vc_row_img2"></div>
                            </a>
                      
                            <a href="investigacion.php" target="_blank" style="text-align: center;">
                                <div class="vc_row_img3"></div>
                            </a>
                        
                            <a href="https://www.sedir.org.pe/condiciones-del-clima.php" target="_blank" style="text-align: center;">
                                <div class="vc_row_img4"></div>
                            </a>
        ...
        <!--BANNER REVISTA SEDIR -->
        <section style="width:1080px; background-color: #FFF;padding-bottom: 25px;margin: auto; background-color: #dbdbdb;">
            <div class="vc_row" style="width: 100%; padding: 0;">
	            <a href="https://www.sedir.org.pe/revista-detalle.php" target="_blank">
	  	            <img src="https://www.sedir.org.pe/imgs/Banner-Revista-2daEdicion.jpg" alt="Revista 2da Edición">
	            </a>
            </div>
        </div>
        ...
        <section style="width:1080px; background-color: #FFF; padding-bottom: 40px;margin: auto;"><!--fondo saludo, video -->
			<div class="vc_verde">
 ...
 <p>La articulación de mercados es un aspecto clave para ambos escenarios, teniendo como destino el mercado externo.</p>
					...
					<div class="vc_verde_right">
                        <div class="verde_title"><span style="float:left">Canal Audiovisual:&nbsp; </span><span style="font-weight:bold;float:left">[ir a canal &nbsp;</span> 
                            <a href="https://www.youtube.com/channel/UCJXXfE-BCNidYAKdWbyekDQ">
                                <img src="imgs/youtube.png" alt="" width="33px" style="font-weight:bold;float:left">
                            </a>
                            <span style="font-weight:bold;float:left">]</span></div>
                        <iframe width="415" height="234" src="https://www.youtube.com/embed/C6ccbpTBqhA" frameborder="0" allowfullscreen></iframe>
