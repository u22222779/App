                ...
                <div style="width:60%; padding:8px; ">
                    <article>
                        <div style="display:flex; justify-content:space-between;">
                            <div> 
                                <div class="notitit" style="padding-top:15px; margin-left: -6px; "><img src="imgs/Button-PDC.jpg" alt=""></div>
                            </div> 
                            <div> 
                            ...
                            <p class="notitex">Consiste en desarrollar y fortalecer capacidades locales a fin de garantizar la sostenibilidad del desarrollo agrícola. La metodología de desarrollo de los talleres es “aprender haciendo”</p>
                            
                            
                        <div  style="display:flex; margin-left: -30px;">
                            <div  style="padding:15px; ">
                              <a href="PDC-moro.php"><img src="imgs/Button-PDC-Moro.jpg" alt=""></a> 
                            </div>  
                            <div  style="padding:15px; ">
                               <a href="PDC-subcuenca.php"><img src="imgs/Button-PDC-Subcuenca.jpg" alt=""></a> 
                            </div>                                                   
                        </div>
                    </article>
        	    </div>
