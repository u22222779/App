                ...
                <div style="width:60%; padding:8px; ">
                    <article>
                            ...
                            <div style="display:flex; justify-content:space-between;">
                                <div class="notitit" style="padding:15px; margin-left: -35px;"><img src="imgs/Button-CIEA-Investigacion.jpg" alt=""></div>
                                <div> 
                            ...
                            <strong class="notitit" style="padding-left:30px;">Investigación</strong>
                            <p style="padding-left:30px;" class="notitex">
                                SEDIR promoverá la investigación teniendo como aliados a los centros de educación superior como son, universidades e institutos.
                                Las investigaciones deben ser en la modalidad de proyectos de tesis y como requisito principal es su aplicación dentro del área de intervención de nuestra organización.
                            </p>
