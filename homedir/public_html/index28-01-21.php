...
<div id="boxed_layout">
	<div id="top_bg">
		...
		<section style="width:1080px; background-color: #e4dbba;"><!--fondo de ejemplo-->
			<div class="vc_row">
		...
		<section style="width:1080px; background-color: #FFF;padding-bottom: 25px;">
            <div class="vc_row">
                ...
                <div class="radio" style="background-image: url('http://www.sedir.org.pe/imgs/radio-online.jpg'); background-repeat: no-repeat; padding: 0; width:312px; height:290px;" >
                            <!-- RADIO SEDIR http://xcdn.player.streamingradio.me/sedir/  -->
                            <iframe width="90" height="130" scrolling="no" border="0" style="border: 0; margin: 20px 0 0 125px;" src="http://rcdn.interconexion.net.pe/player/"></iframe>
...
Nuestra área de intervención involucra a dos ámbitos: Zona costa, en el cual la actividad se concentra más que todo en la fruticultura; y el ámbito de la sierra, espacio en el cual la práctica agrícola es más con fines de autoconsumo, pero que a la vez hay potenciales para un desarrollo productivo con un valor diferenciado, cuyos productos serían destinados a mercados especializados.
 ...
 <p>La articulación de mercados es un aspecto clave para ambos escenarios, teniendo como destino el mercado externo.</p>
					...
					<div class="vc_verde_right">
                        ...
                        <iframe width="415" height="234" src="https://www.youtube.com/embed/0BOWQ-0R9oM" frameborder="0" allowfullscreen></iframe>
