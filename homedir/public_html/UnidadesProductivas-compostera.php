                ...
                <div style="width:60%; padding:8px; ">
                    <article>
                            ...
                            <div style="display:flex; justify-content:space-between;">
                                <div class="notitit" style="padding:15px; margin-left: -35px; "><img src="imgs/Button-UnidadesProductivas-compos.jpg" alt=""></div>
                                <div> 
                            ...
                            <br><br>
                            <strong class="notitit" style="padding-left:30px;">Compostera</strong>
                            <div style="padding-left:30px;">
                            <p class="notitex">
                            Producimos fertilizante orgánico cuyo componente básico es el estiércol de animales, mezcladas con desechos orgánicos de la agricultura, que pasan por un proceso de descomposición generadas por microorganismos específicos.
                            Éste producto además de contener nutrientes, actúa principalmente como un mejorador de suelos para la práctica de la agricultura.
                            ...
                            <div style="padding:15px 0 20px; ">
                                   <img src="imgs/Compostera1.jpg" alt=""> 
                            </div>                                                                                                                                    
                            <div style="padding:15px 0 20px; ">
                                   <img src="imgs/Compostera2.jpg" alt=""> 
                            </div>                                   
