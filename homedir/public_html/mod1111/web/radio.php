...
"></div> 
		...
		<section style="width:1080px; background-color: #FFF;">
                ...
                <div class="" style=" margin: auto; padding: 20px;position: relative;
            "> <!-- RADIO SEDIR-->
                    <iframe width="720" height="355" border="0" style="border: 0; box-shadow: 1px 1px 0  #fff;" src="http://xcdn.player.streamingradio.me/sedir/"></iframe>
                </div>
